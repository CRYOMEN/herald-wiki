...
- **Type:** Human
- **Role:** Key backstory character - the woman [Alekandras](Alekandras.md) loved in Ancient Egypt; the ancestor whose DNA modification created [Jasmine's](Jasmine.md) genetic legacy. At court she was the connecting link between Amun-Ra and the rest of Egypt (specifically the court and [Cleopatra](Cleopatra VII.md)).
...
- **Appearances:** Referenced in backstory across [Alekandras](Alekandras.md), [Jasmine](Jasmine.md). Appears directly in the Flashback events. Her memories will surface through [Jasmine's](Jasmine.md) subconscious genetic backup.
- **Plot function:** The origin of [Jasmine's](Jasmine.md) genetic legacy.