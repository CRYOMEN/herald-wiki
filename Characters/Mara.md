...
- **Name:** Mara (self-given name)
- **Alias(es):** The Witch
- **Type:** TBD
- **Role:** Side/story character.
- **Demographics (optional):** TBD.
...
- **Origin:** TBD. Lives in the underground.
- **Key past events:** TBD.
- **Ties to the world:** Protected by [Stalker](Stalker.md).

## 5. Relationships

- **Allies:** [Stalker](Stalker.md).
- **Enemies:** TBD.
- **Dependents / others:** TBD.
- **Public perception (optional):** Known as a witch in the underground.
