# Character Sheet - Secret Organization Leader

## 1. Identity

- **Name:** Unknown.
- **Alias(es):** "The Antagonist Leader"; "the ruthless operative."
- **Type:** Human
- **Role:** Antagonist - field commander of the secret organization.
...
- **Voice/speech (optional):** Direct, threatening.
...
- **Allies:** TBD.
- **Enemies:** TBD.
- **Dependents / others:** His soldiers.
- **Public perception (optional):** Unknown to the public. Within the organization: a field commander trusted with their most important operation.

## 6. Abilities and equipment

- **Skills:** Military command. Tactical skills.
- **Weapons / gear:** Commands tanks, heavy artillery, and infantry.
- **Special capabilities:** None (human). Has access to the secret organization's considerable resources and intelligence.
