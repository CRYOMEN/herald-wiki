...
- **Alias(es):** None
- **Type:** Human
- **Role:** Supporting character; [Jasmine Foster's](Jasmine Foster.md) mother.
- **Demographics:** Middle-aged, female.

## 2. Physical

- **Build:** Average build.
- **Distinctive traits:** Shares some of the same refined features as [Jasmine Foster](Jasmine Foster.md), but with the signs of a life of modest means.
- **Voice/speech:** Soft-spoken but firm when it comes to her family.
...
- **Allies:** [Jasmine Foster](Jasmine Foster.md) (daughter), [Eleanor Foster](Eleanor Foster.md) (mother).
- **Others:** [Julian Holloway](Julian Holloway.md) (ex-partner; they still love each other deeply but live separately for the sake of the family's security; they have almost no contact).
- **Dependents / others:** [Jasmine Foster](Jasmine Foster.md).
...
- **Plot function:** Provides a grounding influence and home for Jasmine.
