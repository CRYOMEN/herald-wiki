...
- **Role:** The most dangerous inhabitant of the underground. Guardian of [Mara](Mara.md). Key figure in Jasmine's flashback arc.
...
- **Appearances:** Encounters with [Jasmine](Jasmine.md) and [Lizardman](Lizardman.md). Key role in the flashback arc.
- **Plot function:** Will take [Jasmine](Jasmine.md) to the desert, through a temporal rift into the past, where she will witness who she was in a previous life — playing as the slave ([Iras](Iras.md)) who was gifted to [Alekandras](Alekandras.md). This is one of the key flashback events in the story.
- **Possible arcs:** TBD.
- **Archetype (optional):** Unseen terror; unlikely guide.

## References
![Stalker-AI-Gen.png](../Media/Stalker-AI-Gen.png)